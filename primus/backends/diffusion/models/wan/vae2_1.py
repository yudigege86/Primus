...
"""
Wan2.1 VAE (vendored from official Wan2.2 repo).

Source: `Wan2.2/wan/modules/vae2_1.py`
...
class Wan2_1_VAE:
    def __init__(self, z_dim=16, vae_pth="cache/vae_step_411000.pth", dtype=torch.float, device="cuda"):
        ...
        if vae_pth is None:
            raise ValueError("Wan2_1_VAE requires `vae_pth` (checkpoint path).")
...
# Backward-compat alias (older Wan naming)
WanVAE = Wan2_1_VAE
